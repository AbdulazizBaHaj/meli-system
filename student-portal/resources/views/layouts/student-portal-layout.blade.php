        ...
        <div class="row flex-nowrap">
            <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    <a href="/"
                        class="d-flex align-items-center pb-3 my-0 mx-auto text-white text-decoration-none">
                        <span class="fs-5 d-none d-sm-inline"><img src="/assets/images/sysadminImg/logo-dark.png"
                                class="fluid-img m-auto" style="max-width: 150px; min-width: 50px;"></span>
                    </a>
                ...
                <nav class="navbar bg-body-tertiary mb-3">
                    <div class="container-fluid d-flex justify-content-end">
                        <a class="navbar-brand" href="#"><img
                                src="/assets/images/sysadminImg/logo-almajdouie.png" class="fluid-img m-auto"
                                style="max-width: 150px;"></a>
                    </div>
                </nav>
                <div class="fluid-container px-3 px-md-5">
                    <div class="fluid-container">
                        <div class="row">
                            <h1>Menu Title</h1>
                        </div>

                        <div class="row fluid-container menu-content p-2">
