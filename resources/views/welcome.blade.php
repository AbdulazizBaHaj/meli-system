                        ...
                        <div class="col card-filter">
                            <div class="card h-100">
                                <img src="assets\images\websiteImg\prog-01.png" class="card-img-top m-auto img-fluid"
                                    alt="...">
                                <div class="card-body">
                                    <h5 class="card-title card-h5">CERTIFICATE IN PROCUREMENT AND SUPPLY OPERATIONS - CIPS</h5>
                                    ...
                                    <div class="container text-center">
                                        <div class="row">
                                            <div class="col-lg h-auto">
                                                <span class="card-col-title align-bottom"><span><i class="bi bi-calendar3"></i> Course Date</span></span><br>
                                                <span class="card-col-val align-top">31.07.2023</span>
                                            </div>
                                            <div class="col-lg h-auto">
                                                <span class="card-col-title align-bottom"><span><i class="bi bi-clock"></i> Duration</span></span><br>
                                                <span class="card-col-val align-top">2 Months</span>
                                            </div>
                                            <div class="col-lg h-auto">
                                                <span class="card-col-title align-bottom"><span><i class="bi bi-translate"></i> Language</span></span><br>
